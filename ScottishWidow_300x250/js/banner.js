...
Banner.prototype.onVisible = function () {
  ...
  this.politeLoad(['https://cdnjs.cloudflare.com/ajax/libs/gsap/1.18.0/TweenLite.min.js', 'https://cdnjs.cloudflare.com/ajax/libs/gsap/1.18.0/TimelineLite.min.js', 'https://cdnjs.cloudflare.com/ajax/libs/gsap/1.18.0/plugins/CSSPlugin.min.js', 'https://cdnjs.cloudflare.com/ajax/libs/gsap/1.18.0/easing/EasePack.min.js'], function () {
    _this.start();
  });
};
